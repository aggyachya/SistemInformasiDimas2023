...
use App\Http\Controllers\RabidController;
...
use App\Http\Controllers\PencatatanKehadiranController;
...
Route::group(['middleware' => ['auth', 'checkRole:admin']], function () {
    ...
    Route::get('/get-anggota/{id}', [AnggotaController::class, 'getAnggota']);
    
    Route::resource('rabid', RabidController::class);
    Route::post('/rabid/set-waktu-selesai/{id}', [RabidController::class, 'setWaktuSelesai'])->name('rabid.set-waktu-selesai');
    Route::get('/get-rabid/{id}', [RabidController::class, 'getRabid']);

    Route::resource('kehadiran', KehadiranController::class);


    Route::resource('pencatatan_kehadiran', PencatatanKehadiranController::class);
    Route::get('/get-pencatatan-kehadiran/{id}', [PencatatanKehadiranController::class, 'getPencatatanKehadiran']);
